...
window.dom = {
  ...
  create: function create(string) {
    ...
    // td不能单独存在
    var container = document.createElement('template'); // trim() 去除空格

    container.innerHTML = string.trim();
    return container.content.firstChild; // return container
  },
  // 新增弟弟
  ...
  previous: function previous(node) {
    var x = node.previousSibling; // 剔除文本节点
