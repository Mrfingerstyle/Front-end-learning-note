...
dom.after(test, div); // const newSpan = dom.create('<span>newSpan</span>')
// dom.before(test, newSpan)
// dom.append(newDiv, dom.create('<p>p tag</p>'))

var div_3 = dom.create('<div id="parent"></div>');
dom.wrap(test, div_3); // let removeNode = dom.remove(test)
// console.log(removeNode);

var ul = document.querySelector('#empty');
var empty = dom.empty(ul);
console.log(empty);
dom.attr(test, 'title', 'hi, I am frank');
var attrValue = dom.attr(test, 'title');
console.log(attrValue);
var spanTag = document.querySelector('#span-tag');
dom.text(spanTag, 'hi');
...
var travel = dom.find('#travel');
dom.each(dom.children(travel), function (n) {
